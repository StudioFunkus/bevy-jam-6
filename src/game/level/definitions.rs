        ...
        Self {
            levels: vec![
                ...
                LevelDefinition {
                    ...
                    starting_mushrooms: vec![],
                    tile_configuration: vec![
                        // Moss / Water decorations
                        (GridPosition::new(1, 1), TileType::BlockedMoss),
                        (GridPosition::new(1, 2), TileType::BlockedWater),
                        (GridPosition::new(2, 1), TileType::BlockedMoss),
                        (GridPosition::new(1, 9), TileType::BlockedMoss),
                        (GridPosition::new(1, 10), TileType::BlockedWater),
                        (GridPosition::new(2, 10), TileType::BlockedMoss),
                        (GridPosition::new(9, 1), TileType::BlockedMoss),
                        (GridPosition::new(10, 1), TileType::BlockedWater),
                        (GridPosition::new(10, 2), TileType::BlockedMoss),
                        ...
                        (GridPosition::new(5, 0), TileType::BlockedRock),
                        (GridPosition::new(6, 0), TileType::BlockedRock),
                        (GridPosition::new(7, 0), TileType::BlockedRock),
                        (GridPosition::new(8, 0), TileType::BlockedRock),
                        ...
                        (GridPosition::new(6, 4), TileType::BlockedRock),
                        (GridPosition::new(7, 4), TileType::BlockedRock),
                        ...
                        (GridPosition::new(6, 7), TileType::BlockedRock),
                        (GridPosition::new(7, 7), TileType::BlockedRock),
                        (GridPosition::new(9, 7), TileType::BlockedRock),
                        (GridPosition::new(10, 7), TileType::BlockedRock),
                        ...
                        (GridPosition::new(8, 11), TileType::BlockedRock),
                        (GridPosition::new(9, 11), TileType::BlockedRock),
                        (GridPosition::new(10, 11), TileType::BlockedRock),
                        (GridPosition::new(11, 11), TileType::BlockedRock),
                        (GridPosition::new(0, 1), TileType::BlockedRock),
                        ...
                        (GridPosition::new(0, 9), TileType::BlockedRock),
                        (GridPosition::new(0, 10), TileType::BlockedRock),
                        (GridPosition::new(0, 11), TileType::BlockedRock),
                        (GridPosition::new(4, 1), TileType::BlockedRock),
                        (GridPosition::new(4, 2), TileType::BlockedRock),
                        (GridPosition::new(4, 4), TileType::BlockedRock),
                        (GridPosition::new(4, 5), TileType::BlockedRock),
                        (GridPosition::new(4, 7), TileType::BlockedRock),
                        (GridPosition::new(4, 8), TileType::BlockedRock),
                        (GridPosition::new(4, 10), TileType::BlockedRock),
                        (GridPosition::new(4, 11), TileType::BlockedRock),
                        (GridPosition::new(7, 1), TileType::BlockedRock),
                        (GridPosition::new(7, 3), TileType::BlockedRock),
                        (GridPosition::new(7, 4), TileType::BlockedRock),
                        (GridPosition::new(7, 6), TileType::BlockedRock),
                        (GridPosition::new(7, 7), TileType::BlockedRock),
                        (GridPosition::new(7, 8), TileType::BlockedRock),
                        (GridPosition::new(7, 9), TileType::BlockedRock),
                        (GridPosition::new(7, 11), TileType::BlockedRock),
                        (GridPosition::new(11, 0), TileType::BlockedRock),
                        (GridPosition::new(11, 1), TileType::BlockedRock),
                        ...
                        (GridPosition::new(11, 7), TileType::BlockedRock),
                        (GridPosition::new(11, 8), TileType::BlockedRock),
                        (GridPosition::new(11, 9), TileType::BlockedRock),
                        (GridPosition::new(11, 10), TileType::BlockedRock),
                    ],
                },
                ...
                LevelDefinition {
                    ...
                    tile_configuration: vec![
                        ...
                        (GridPosition::new(0, 1), TileType::BlockedMoss),
                        (GridPosition::new(1, 0), TileType::BlockedMoss),
                        (GridPosition::new(2, 1), TileType::BlockedMoss),
                        (GridPosition::new(2, 2), TileType::BlockedMoss),
                        (GridPosition::new(3, 3), TileType::BlockedMoss),
